...
exports.app.use(security_middleware_1.corsMiddleware); // Keeping your custom one just in case it handles specific edge cases
...
exports.app.use("/api/webhooks/whatsapp", whatsapp_routes_1.whatsappRouter);
