      ...
      <main className="mx-auto max-w-7xl px-4 py-6 pb-48 sm:px-6 md:py-10 md:pb-10 lg:px-8">
        ...
        <section className="mt-8 grid gap-8 lg:grid-cols-[1fr_380px]">
          ...
          <aside className="h-fit rounded-3xl bg-white p-6 shadow-soft md:sticky md:top-24">
            ...
            {/* STICKY BOTTOM BAR FOR MOBILE & DESKTOP ALIGNED CTA */}
            <div className="fixed inset-x-0 bottom-0 z-50 flex flex-col gap-3 border-t border-slate-200 bg-white p-4 pb-8 shadow-[0_-15px_40px_rgba(0,0,0,0.15)] md:static md:mt-3 md:border-none md:bg-transparent md:p-0 md:shadow-none">
              
              <div className="grid grid-cols-2 gap-2">
                <Button variant="secondary" className="w-full h-12" onClick={() => wishlist.toggle(property?.id)}>
                ...
                <a
                  ...
                  className="flex h-12 items-center justify-center gap-2 rounded-xl bg-[#25D366] px-4 text-sm font-bold text-white transition-colors hover:bg-[#1ebe5d]"
                >
              ...
              <button
                ...
                className={`${buttonClasses("primary", undefined, "w-full")} py-3.5 text-base font-bold tracking-wide`}
              ...
              <button
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-ink py-3.5 text-base font-bold tracking-wide text-white shadow-soft transition hover:bg-black focus:outline-none focus:ring-2 focus:ring-ink/20 disabled:cursor-not-allowed disabled:opacity-60"
              >
                Schedule a Visit
              </button>
