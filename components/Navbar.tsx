...
import { ChevronDown, Heart, Home, LogOut, Phone, Search, UserRound } from "lucide-react";
        ...
        <nav className="mx-auto flex h-20 max-w-7xl items-center justify-between px-8">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="flex items-center gap-2 rounded-full bg-ink px-4 py-2 text-sm font-bold text-white shadow-soft transition hover:opacity-90"
            >
